...
/*   Updated: 2018/04/27 22:08:38 by ntai             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** access to static functions is
** restricted to the file where they
** are declared. Therefore, when we want
** to restrict access to functions,
** we make them static.
** Another reason for making functions static
** can be reuse of the same
